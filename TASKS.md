...
- [ ] Futuro da aba Onboarding — investigado, mais ideias enviadas ao usuário (inclusive aproveitar o status `onboarding` do cliente), aguardando decisão antes de mexer em código
