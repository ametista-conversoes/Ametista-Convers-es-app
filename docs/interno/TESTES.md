...
- [ ] **Desatualizado pela Fase 35.1**: essa linha dizia que `/client-tasks` (Portal Gestor) continuava mostrando só as tarefas do Kanban — isso era um bug (o propósito real da página sempre foi mostrar `client_tasks`), corrigido na Fase 35.1. Ver item mais recente sobre isso.
